    ...
    >
      <div className="p-5 flex flex-col gap-4">
        ...
        <div className="space-y-2">
            ...
            {isPro && tender.relevance != null && (
              <Badge
                ...
                className={`shrink-0 flex items-center gap-1 border-0 ${tender.relevance >= 80 ? 'bg-emerald-500/10 text-emerald-600' :
                  tender.relevance >= 50 ? 'bg-amber-500/10 text-amber-600' :
          ...
          {isPro && tender.description && (
            <p className="text-[11px] text-muted-foreground/80 line-clamp-2 italic leading-snug border-l-2 border-primary/20 pl-2 mt-1">
              {tender.description}
            </p>
          )}
        </div>
